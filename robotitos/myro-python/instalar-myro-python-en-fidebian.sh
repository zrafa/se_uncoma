...
apt-get -y install  git-core build-essential python-serial python-tk libsdl1.2debian libsdl1.2-dev libsdl-image1.2 libsdl-image1.2-dev libcurl3 libcurl3-gnutls libcurl3-nss libcurl4-nss-dev socat curl   unzip idle || exit 1
