...
def spawnSocat():
	...
	socatCmd = [socatBin,"pty,raw,echo=0","tcp:10.0.20.221:2000"]
...
def synch():
	return subprocess.Popen(["duino_sync", "10.0.20.221"])
...
def faivision():
	...
	vision.faivision_init(PYTHON, "10.0.20.221")

def foto():
	url = "http://10.0.20.221:8080?action=snapshot"
	img = "snapshot.png"
