...
def spawnSocat():
	...
	socatCmd = [socatBin,"pty,raw,echo=0","tcp:10.0.20.223:2000"]
...
def synch():
	return subprocess.Popen(["duino_sync", "10.0.20.223"])
...
def faivision():
	...
	vision.faivision_init(PYTHON, "10.0.20.223")

def foto():
	url = "http://10.0.20.223:8080?action=snapshot"
	img = "snapshot.png"
